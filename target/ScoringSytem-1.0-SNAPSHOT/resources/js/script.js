$(document).ready(function () {
    ...
    $('.point-system').css('display', 'none');
    var bracket = false;
    var points = false;
    
    

    $(document).on('click', '.scoreboard', function (e) {
        $('.scoreboard-choice').html($(this).html());

        var autoCompleteData;

        if ($(this).html() == 'Bracket Tournament') {
            if (!bracket) {
                $('.point-system').css('display', 'none');
                $('.bracket-system').css('display', 'block');
                autoCompleteData = {
                    teams: [
                        [null, null],
                        [null, null]
                ...
                $('.bracket-system-body').append('<input type="button" class="btn btn-success" value="Save">');
            ...
            if (!points) {
                ...
                $('.bracket-div-x').remove();
                $('.jQBracket').remove();
                $('.bracket-system').css('display', 'none');
                $('.point-system').css('display', 'block');
                points = true;
                bracket = false;
            }
        }
    ...
    function acEditFn(container, data, doneCb) {
        ...
        input.focus();
        $('.tournament').append('<input type="button" class="btn btn-success" value="Save">');
    }
...
!function (t) {
    ...
    var o, s = function () {
        ...
        return Object.defineProperty(t.prototype, "name", {get: function () {
                ...
                this.nameOrGetter = t
            }, enumerable: !0, configurable: !0}), t.prototype.emptyBranch = function () {
    ...
    var u, l = function () {
        ...
        return t.teamsInResultOrder = function (t) {
            var n = t.a.name.isEmpty(), r = t.b.name.isEmpty();
            if (r && !n)
    ...
    var p;
    function d(e, n, r) {
        var i = r.find(".team[data-teamid=" + e + "]"), o = n || "highlight";
    ...
    var v = function () {
        ...
        return function () {
            var i = new a(v, function () {
                return t[e][0]
            }, n.of(s.first()), n.of(2 * e), r.empty()), o = new a(v, function () {
                return t[e][1]
    ...
    var E = function (t, e, n, r, i, o) {
        ...
        return function (e, n) {
            var r = e.height() / 4, i = {height: 0, shift: 2 * r};
    ...
    var T = function () {
        ...
        return Object.defineProperty(e.prototype, "el", {get: function () {
                return this.roundCon
            }, enumerable: !0, configurable: !0}), e.prototype.addMatch = function (t, e) {
            var i = this, o = this.matches.length, h = null !== t ? t() : [{source: function () {
                ...
                return h[1].source()
            }, p = new a(c, c().name, n.of(s.first()), c().seed, r.empty()), d = new a(u, u().name, n.of(s.second()), u().seed, r.empty());
            p.sibling = function () {
                return d
            }, d.sibling = function () {
                return p
            };
            var f = new l(p, d), m = this.mkMatch(this, f, o, this.roundResults.map(function (t) {
        ...
        return Object.defineProperty(t.prototype, "el", {get: function () {
                return this.bracketCon
            }, enumerable: !0, configurable: !0}), t.prototype.addRound = function (t) {
            var e = this.rounds.length, o = e > 0 ? n.of(this.rounds[e - 1]) : n.empty(), s = this.initResults.map(function (t) {
    ...
    function B(i, o, s, a, c, l, p, d, f, m) {
        var g = s.name.isEmpty() || a.name.isEmpty() ? "" : 'data-resultid="result-' + d.getNext() + '"', b = t('<div class="score" style="width: ' + p.scoreWidth + 'px;" ' + g + "></div>"), v = s.name.isEmpty() || a.name.isEmpty() || !c ? n.empty() : s.score.map(function (t) {
            return "" + t
        }), y = v.orElse("--");
        b.text(y);
        var C = t('<div class="team" style="width: ' + (p.teamWidth + p.scoreWidth) + 'px;"></div>'), E = t('<div class="label" style="width: ' + p.teamWidth + 'px;"></div>').appendTo(C);
        ...
        if (s.seed.forEach(function (t) {
            ...
            b.addClass("editable"), b.click(function () {
                ...
                !function n() {
                    e.unbind();
                    var i = h(s.score) ? e.text() : "0", o = t('<input type="text">');
    ...
    var N = function () {
        ...
        return Object.defineProperty(e.prototype, "el", {get: function () {
            ...
            }, enumerable: !0, configurable: !0}), e.prototype.getRound = function () {
            return this.round
        }, e.prototype.setConnectorCb = function (t) {
            this.connectorCb = t
        }, e.prototype.connect = function (e) {
            var n = this, r = "lr" === this.opts.dir ? "right" : "left", i = this.teamCon.height() / 4, o = this.matchCon.height() / 2, s = e.map(function (t) {
                ...
                }).orElse({height: o - i * (n.opts.centerConnectors ? 0 : 1), shift: 2 * i}) : n.winner().order.map(function (t) {
            ...
            this.teamCon.append(function (e, n, r, i) {
                var o = n.shift, s = R(n.height), a = s.height, h = s.drop, c = e / 2, u = t('<div class="connector"></div>').appendTo(r);
        ...
        var r = new O, i = e.init, o = i.results.length <= 1, s = 45 * i.teams.length + i.teams.length * e.matchMargin, a = t('<div class="jQBracket ' + e.dir + '"></div>').appendTo(e.el.empty());
        function h() {
        ...
        function p(n) {
            r.reset(), c.render(), u && u.render(), l && !e.skipGrandFinalComeback && l.render(), e.disableHighlight || function (e, n, r) {
                var i = r || n, o = i.winner(), s = i.loser();
        ...
        return c = new M(m, n.of(i.results[0] || null), T, !0, e), o || (u = new M(v, n.of(i.results[1] || null), T, !1, e), e.skipGrandFinalComeback || (l = new M(f, n.of(i.results[2] || null), T, !1, e))), function (t, e, r, i, o) {
            ...
            if (r && (t.final().setConnectorCb(n.empty()), e.length > 1 && !i.skipConsolationRound)) {
                var d = t.final().getRound().prev(), f = d.map(function (t) {
                    return function () {
                        return t.match(0).loser()
                    }
                }).toNull(), m = d.map(function (t) {
                    return function () {
                        return t.match(1).loser()
                    }
                }).toNull(), v = s.addMatch(function () {
            ...
            for (var s = Math.log(2 * r) / Math.log(2) - 1, a = r / 2, h = 0; h < s; h += 1) {
                for (var c = i && h === s - 1 ? 1 : 2, u = 0; u < c; u += 1)
                    for (var l = e.addRound(n.empty()), p = 0; p < a; p += 1) {
                        var d = u % 2 != 0 || 0 === h ? E(t, e, a, p, u, h) : null, f = h === s - 1 && i, m = l.addMatch(d, n.of(f ? b : null));
            ...
            var a = t.addRound(n.empty()), h = a.addMatch(function () {
                return [{source: function () {
                            return e.winner()
                        }}, {source: function () {
                            return r.winner()
            ...
            if (h.setAlignCb(function (t) {
                ...
                var c = r.final().getRound().prev(), u = a.addMatch(function () {
                    return [{source: function () {
            ...
            e.final().setConnectorCb(n.of(function (t) {
                var n = t.height() / 4, o = (e.el.height() / 2 + e.el.height() + r.el.height() / 2) / 2 - t.height() / 2 - e.el.height() / 2, s = e.winner().order.map(function (t) {
                ...
                }).orElse({height: o + n * (i.centerConnectors ? 2 : 1), shift: 2 * n}), a = s.height, h = s.shift;
                return {height: a - t.height() / 2, shift: h}
            })), r.final().setConnectorCb(n.of(function (t) {
                var n = t.height() / 4, o = (e.el.height() / 2 + e.el.height() + r.el.height() / 2) / 2 - t.height() / 2 - e.el.height() / 2, s = r.winner().order.map(function (t) {
    ...
    var F = function (t, e) {
        ...
        if (r < t)
            ...
            o.decorator || (o.decorator = {edit: f, render: m}), o.init || (o.init = {results: [], teams: [[n.empty(), n.empty()]]}), o.el = this, o.save && (o.onMatchClick || o.onMatchHover) && t.error("Match callbacks may not be passed in edit mode (in conjunction with save callback)");
            var s = typeof o.disableToolbar, a = o.hasOwnProperty("disableToolbar");
            ...
            var h = typeof o.disableTeamEdit, c = o.hasOwnProperty("disableTeamEdit");
            ...
            g !== Math.floor(g) && t.error('"teams" property must have 2^n number of team pairs, i.e. 1, 2, 4, etc. Got ' + o.init.teams.length + " team pairs."), o.dir = o.dir || "lr", o.init.teams = o.init.teams && 0 !== o.init.teams.length ? o.init.teams : [[null, null]], o.init.teams = o.init.teams.map(function (t) {
                return t.map(function (t) {
